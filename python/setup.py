...
list_files.append('../src/helm_wrappers/helm_s_neu.f90')
list_files.append('../src/lap_wrappers/lap_comb_dir.f90')
list_files.append('../src/lap_wrappers/lap_s_neu.f90')
...
list_files.append('../src/quadratures/far_field_routs.f90')
...
lap.append('lap_comb_dir_eval')
lap.append('lpcomp_lap_comb_dir_addsub')
lap.append('getnearquad_lap_s_neu')
lap.append('lpcomp_lap_s_neu_addsub')
...
helm.append('lpcomp_helm_comb_dir_addsub')
helm.append('getnearquad_helm_s_neu')
helm.append('lpcomp_helm_s_neu_addsub')
